...
class DownloadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create download" do
    assert_difference("Download.count") do
      post downloads_url, params: { download: { title: @download.title, user_id: @download.user_id } }
    end
  ...
  test "should update download" do
    patch download_url(@download), params: { download: { title: @download.title, user_id: @download.user_id } }

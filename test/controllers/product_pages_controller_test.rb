...
class ProductPagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_page" do
    assert_difference("ProductPage.count") do
      post product_pages_url, params: { product_page: { description: @product_page.description, name: @product_page.name, price: @product_page.price } }
    end
  ...
  test "should update product_page" do
    patch product_page_url(@product_page), params: { product_page: { description: @product_page.description, name: @product_page.name, price: @product_page.price } }
